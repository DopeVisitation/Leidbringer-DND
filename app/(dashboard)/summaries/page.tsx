...
import { BookText, Calendar, MessageCircle, Heart, HeartCrack, Star, HelpCircle, Send, Trash2, Edit2, Save, X } from 'lucide-react'
...
export default function SummariesPage() {
  ...
  const loadAll = useCallback(async () => {
    ...
    const [{ data: sess }, { data: sums }, { data: cmts }] = await Promise.all([
      supabase.from('sessions').select('id,title,description,start_date,end_date').order('start_date', { ascending: false }),
